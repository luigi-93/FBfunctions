...
let App = class App {
    constructor(logger, apiApp, serverInitializer) {
        this.logger = logger;
        this.apiApp = apiApp;
...
exports.App = App = __decorate([
    ...
    __param(1, (0, inversify_1.inject)(utilityKeys_1.SYMBOLS.API_APP)),
    __param(2, (0, inversify_1.inject)(utilityKeys_1.SYMBOLS.SERVER_INITIALIZER)),
...
async function createApp() {
    ...
    try {
        ...
        const initializedContainer = await (0, ioc_1.initializeContainer)();
